 ...
 *
 * As the user undos, redos, calculates new operations, and removes entries the undo-redo pointer
...
public class HistoryManager{
     ...
     *
     * @return A boolean denoting if the index is size()
     */
     ...
     * @return A boolean denoting if the currentIndex == num
     */
